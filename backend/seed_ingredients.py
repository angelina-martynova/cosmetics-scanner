...
INGREDIENTS = [
    ...
    {"name": "CI 77499", "inci_name": "CI 77499",
     ...
     {"name": "Propanediol", "inci_name": "Propanediol", "risk_level": "low",
     "category": "solvent",
     "description": "1,3-пропандіол, біорозкладний розчинник",
     "description_en": "1,3-Propanediol, biodegradable solvent",
     "cas_number": "504-63-2", "ewg_score": 1,
     "source_of_risk_assessment": "CosIng"},

    {"name": "Cetyl Ethylhexanoate", "inci_name": "Cetyl Ethylhexanoate",
     "risk_level": "low", "category": "emollient",
     "description": "Емолєнт, пом'якшує шкіру, легка текстура",
     "description_en": "Emollient, skin softening with light texture",
     "cas_number": "59130-69-7", "ewg_score": 1},

    {"name": "1,2-Hexanediol", "inci_name": "1,2-Hexanediol",
     "risk_level": "low", "category": "solvent",
     "description": "Розчинник та консервант-бустер",
     "description_en": "Solvent and preservative booster",
     "cas_number": "6920-22-5", "ewg_score": 1},

    {"name": "Hydroxyacetophenone", "inci_name": "Hydroxyacetophenone",
     "risk_level": "low", "category": "preservative",
     "description": "Антиоксидант та консервант-бустер",
     "description_en": "Antioxidant and preservative booster",
     "cas_number": "99-93-4", "ewg_score": 1},

    {"name": "Tromethamine", "inci_name": "Tromethamine",
     "risk_level": "low", "category": "pH adjuster",
     "description": "TRIS, регулятор pH",
     "description_en": "TRIS, pH adjuster",
     "cas_number": "77-86-1", "ewg_score": 1},

    {"name": "Dipotassium Glycyrrhizate", "inci_name": "Dipotassium Glycyrrhizate",
     "risk_level": "low", "category": "active",
     "description": "Похідна кореня солодки, заспокоює шкіру",
     "description_en": "Licorice root derivative, soothing agent",
     "cas_number": "68797-35-3", "ewg_score": 1},

    {"name": "Ginkgo Biloba Leaf Extract", "inci_name": "Ginkgo Biloba Leaf Extract",
     "risk_level": "low", "category": "plant extract",
     "description": "Екстракт листя гінкго, антиоксидант",
     "description_en": "Ginkgo biloba leaf extract, antioxidant",
     "cas_number": "90045-36-6", "ewg_score": 1},

    {"name": "Ulmus Davidiana Root Extract", "inci_name": "Ulmus Davidiana Root Extract",
     "risk_level": "low", "category": "plant extract",
     "description": "Екстракт кореня в'яза, зволожує та пом'якшує",
     "description_en": "Elm root extract, moisturizing and softening",
     "cas_number": "", "ewg_score": 1},

    {"name": "Centella Asiatica Extract", "inci_name": "Centella Asiatica Extract",
     "risk_level": "safe", "category": "plant extract",
     "description": "Екстракт центелли, загоює, зміцнює бар'єр шкіри",
     "description_en": "Centella asiatica extract, wound healing, strengthens skin barrier",
     "cas_number": "84696-21-9", "ewg_score": 1},

    {"name": "Beta-Glucan", "inci_name": "Beta-Glucan",
     "risk_level": "safe", "category": "active",
     "description": "Полісахарид, заспокоює та зміцнює захисний бар'єр",
     "description_en": "Polysaccharide, soothes and strengthens skin barrier",
     "cas_number": "9004-65-3", "ewg_score": 1},
    ...
    {"name": "Polyglyceryl-3 Methylglucose Distearate", "inci_name": "Polyglyceryl-3 Methylglucose Distearate",
     "risk_level": "low", "category": "emulsifier",
     "description": "Емульгатор на основі глюкози, безпечний для шкіри",
     "description_en": "Glucose-based emulsifier, skin friendly",
     "cas_number": "", "ewg_score": 1},

    {"name": "Beeswax", "inci_name": "Cera Alba",
     "risk_level": "safe", "category": "emollient",
     "description": "Бджолиний віск, захищає та пом'якшує шкіру",
     "description_en": "Beeswax, protects and softens skin",
     "cas_number": "8012-89-3", "ewg_score": 1},
    ...
    {"name": "Camellia Sinensis Leaf Extract", "inci_name": "Camellia Sinensis Leaf Extract",
     "risk_level": "safe", "category": "plant extract",
     "description": "Екстракт зеленого чаю, антиоксидант, заспокоює",
     "description_en": "Green tea extract, antioxidant, soothing",
     "cas_number": "84650-56-2", "ewg_score": 1},

    {"name": "Salix Alba Bark Extract", "inci_name": "Salix Alba (Willow) Bark Extract",
     "risk_level": "low", "category": "plant extract",
     "description": "Екстракт кори білої верби, містить саліцилати, відлущує",
     "description_en": "White willow bark extract, contains salicylates, exfoliating",
     "cas_number": "84082-82-6", "ewg_score": 1},

    {"name": "Vaccinium Angustifolium Fruit Extract", "inci_name": "Vaccinium Angustifolium (Blueberry) Fruit Extract",
     "risk_level": "safe", "category": "plant extract",
     "description": "Екстракт чорниці, багатий антоцианами, антиоксидант",
     "description_en": "Blueberry fruit extract, rich in anthocyanins, antioxidant",
     "cas_number": "", "ewg_score": 1},

    {"name": "Vaccinium Palustris Leaf Extract", "inci_name": "Vaccinium Palustris Leaf Extract",
     "risk_level": "safe", "category": "plant extract",
     "description": "Екстракт листя журавлини болотної, антиоксидант",
     "description_en": "Bog cranberry leaf extract, antioxidant",
     "cas_number": "", "ewg_score": 1},

    {"name": "Oenothera Biennis Flower Extract", "inci_name": "Oenothera Biennis (Evening Primrose) Flower Extract",
     "risk_level": "safe", "category": "plant extract",
     "description": "Екстракт квітів ослинника, живить та пом'якшує",
     "description_en": "Evening primrose flower extract, nourishing and softening",
     "cas_number": "90028-66-3", "ewg_score": 1},

    {"name": "Pueraria Lobata Root Extract", "inci_name": "Pueraria Lobata Root Extract",
     "risk_level": "safe", "category": "plant extract",
     "description": "Екстракт кореня пуерарії, зволожує, антиоксидант",
     "description_en": "Kudzu root extract, moisturizing, antioxidant",
     "cas_number": "90028-67-4", "ewg_score": 1},
]
